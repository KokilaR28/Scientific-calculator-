...
tk_calc = Tk()
tk_calc.configure(bg="#DCDCDC", bd=15)
...
button_params = {'bd':5, 'fg':'#FFE4C4', 'bg':'#2F4F4F', 'font':('sans-serif', 20, 'bold')}
button_params_main = {'bd':5, 'fg':'#000', 'bg':'#CAFF70', 'font':('sans-serif', 20, 'bold')}
